...
League average types represent **per-match averages** calculated across all fixtures played in a league season. They are attached to fixtures as metrics and can be used as filter criteria in [`/fixtures/search`](./search.md).

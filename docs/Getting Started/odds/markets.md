...
| market_id | Market Name                     | label_id → Outcome                                                     |
| --------- | ------------------------------- | ---------------------------------------------------------------------- |
...
3. **Correct Score encoding** — label_id always starts with `1`. Strip it, then read remaining digits as home+away goals (e.g., `142` → `4:2`).
